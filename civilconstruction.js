const civilContainer =
document.getElementById("civilContainer");
...
async function loadCivilWorks() {
    ...
    try {
        ...
        civilContainer.innerHTML = "";
        if(data.data.length > 0){

    civilHeader.innerHTML = `
                    ...
                    >
                        ...
                        <div class="carousel-track">
                            ...
                            ${work.images.map(img => `
                                ...
                                <img 
                                  src="http://zirconhome.onrender.com${img}"
                                  alt=""
                                >
    ...
    .forEach(carousel => {
        ...
        carousel.addEventListener("click", (e) => {
            ...
            work.imageDetails.map(item => ({
                src:
                `http://zirconhome.onrender.com${item.image}`,
...
// LIGHTBOX
const lightbox =
document.getElementById("lightbox-civil");

const trackLB =
document.getElementById("lightbox-track-civil");

const lbTitle =
document.getElementById("lb-title-civil");

const lbText =
document.getElementById("lb-text-civil");
