const plumbingContainer =
document.getElementById("plumbingContainer");
...
async function loadPlumbingWorks() {
    ...
    try {
        ...
        const res = await fetch(
            "http://localhost:5000/api/plumbing"
        );

        const data = await res.json();

        plumbingContainer.innerHTML = "";
        if(data.data.length > 0){

    plumbingHeader.innerHTML = `
    ...
    `;
        ...
        data.data.forEach((work, sectionIndex) => {
            ...
            <div class="plumbing-type">

                <div class="plumbing-header">
                    ${work.sectionTitle}
                </div>
...
// LIGHTBOX
const lightbox =
document.getElementById("lightbox-plumbing");

const trackLB =
document.getElementById("lightbox-track-plumbing");

const lbTitle =
document.getElementById("lb-title-plumbing");

const lbText =
document.getElementById("lb-text-plumbing");
