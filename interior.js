...
document.getElementById("interiorContainer");
...
async function loadInteriorWorks() {
    ...
    try {
        ...
        const res = await fetch(
            "http://localhost:5000/api/interior"
        );
...
// LIGHTBOX
const lightbox =
document.getElementById("lightbox-interior");

const trackLB =
document.getElementById("lightbox-track-interior");

const lbTitle =
document.getElementById("lb-title-interior");

const lbText =
document.getElementById("lb-text-interior");
