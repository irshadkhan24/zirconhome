...
${t.image ? `<img src="https://zirconhome.onrender.com${t.image}" width="100"><br>` : ""}
...
await fetch("https://zirconhome.onrender.com/api/testimonials/"+id,{
method:"PUT",
...
await fetch("https://zirconhome.onrender.com/api/testimonials",{
method:"POST",
headers:{ Authorization:"Bearer "+token },
body:formData
});
