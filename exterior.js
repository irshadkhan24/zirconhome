...
document.getElementById("exteriorContainer");
...
async function loadExteriorWorks() {
    ...
    try {
        ...
        const res = await fetch(
            "http://localhost:5000/api/exterior"
        );
...
// LIGHTBOX
const lightbox =
document.getElementById("lightbox-exterior");

const trackLB =
document.getElementById("lightbox-track-exterior");

const lbTitle =
document.getElementById("lb-title-exterior");

const lbText =
document.getElementById("lb-text-exterior");
